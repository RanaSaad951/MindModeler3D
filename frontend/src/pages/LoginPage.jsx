...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Admin bypasses normal routing → go straight to /admin
  ...
  return (
    <div className="min-h-screen bg-grid-pattern flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 -left-32 w-80 h-80 rounded-full opacity-8"
          style={{ background: 'radial-gradient(circle, #06b6d4, transparent 70%)' }} />
        <div className="absolute bottom-1/4 -right-32 w-80 h-80 rounded-full opacity-8"
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Mind Modeler 3D · Clinical AI Platform</p>
        </div>
